...
OPENMVG_SFM_BIN = "/home/yuancaimaiyi/文档/openMVG/src/build/Linux-x86_64-Release"

# Indicate the openMVG camera sensor width directory
CAMERA_SENSOR_WIDTH_DIRECTORY = "/home/yuancaimaiyi/文档/openMVG/src/software/SfM" + "/../../openMVG/exif/sensor_width_database"
...
pFeatures = subprocess.Popen( [os.path.join(OPENMVG_SFM_BIN, "openMVG_main_ComputeFeatures"),  "-i", matches_dir+"/sfm_data.json", "-o", matches_dir, "-m", "SIFT", "-p", "HIGH", "--numThreads", "12"] )
pFeatures.wait()
...
pMatches = subprocess.Popen( [os.path.join(OPENMVG_SFM_BIN, "openMVG_main_ComputeMatches"),  "-i", matches_dir+"/sfm_data.json", "-p", matches_dir+ "/pairs.bin", "-o", matches_dir + "/matches.putative.bin", "-r", "0.7" ] )
pMatches.wait()
