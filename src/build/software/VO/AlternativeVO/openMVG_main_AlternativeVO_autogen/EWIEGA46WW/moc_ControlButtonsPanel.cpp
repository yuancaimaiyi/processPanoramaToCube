...
#include "ControlButtonsPanel.hpp"
...
void alternative_vo::ControlButtonsPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ControlButtonsPanel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ControlButtonsPanel::*)();
...
QT_INIT_METAOBJECT const QMetaObject alternative_vo::ControlButtonsPanel::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_alternative_vo__ControlButtonsPanel.data,
    qt_meta_data_alternative_vo__ControlButtonsPanel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
