  ...
  public:
    ...
    */
    Pinhole_Intrinsic(
      ...
      double focal_length_pix_x = 0.0,
      double focal_length_pix_y = 0.0,
    ...
    */
    ...
    {
//      std::cout << "focal xy:" <<focal().x()  <<" "<<focal().y()<<"\n";
//      std::cout << "principal xy:" <<principal_point().x()  <<" "<<principal_point().y()<<"\n";
      return Vec2(focal().x() * p.x() + principal_point().x(),
                  focal().y() * p.y() + principal_point().y());
    }
    ...
    */
    ...
    {
      return Vec2((p.x() - principal_point().x()) / focal().x(),
                    (p.y() - principal_point().y()) / focal().y());
    }
    ...
    */
    bool updateFromParams(const std::vector<double> & params) override
    {
      if ( params.size() == 4 )
      {
        *this = Pinhole_Intrinsic( w_, h_, params[0], params[1], params[2],params[4] );
        return true;
      }
      else
      {
