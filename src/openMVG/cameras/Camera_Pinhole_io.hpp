...
void openMVG::cameras::Pinhole_Intrinsic::save( Archive & ar ) const
{
    ...
    ar( cereal::make_nvp( "focal_length_x", K_( 0, 0 )) );
    ar( cereal::make_nvp( "focal_length_y", K_( 1, 1 ) ) );
...
void openMVG::cameras::Pinhole_Intrinsic::load( Archive & ar )
{
    ...
    ar( cereal::make_nvp( "focal_length_x", focal_length_x ) );
    ar( cereal::make_nvp( "focal_length_y", focal_length_y ) );
    std::vector<double> pp( 2 );
    ar( cereal::make_nvp( "principal_point", pp ) );
    *this = Pinhole_Intrinsic( w_, h_, focal_length_x,focal_length_y, pp[0], pp[1] );
}
