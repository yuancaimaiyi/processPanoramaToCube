...
)
{
  ...
  const int renderer_image_size_height = pinhole_camera.h();
  const int renderer_image_size_width = pinhole_camera.w();
  ImageT pinhole_image(renderer_image_size_width, renderer_image_size_height);
